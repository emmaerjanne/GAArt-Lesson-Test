...
{
    //speed we want the char to move
    ...
    void Update()
    {
        ...
        //make sure the char is on the ground by checking the distance from the char downwards
        ...
        //if the char is on the ground and "jump" spacebar is pushed, the char jumps
